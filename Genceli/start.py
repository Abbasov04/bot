...
bot_token = "5746131579:AAFf_Gt_oyZerzkbDUzZICJIHsFdYROhi2Y"
  ...
  if event.is_private:
    ...
    await event.respond("**Qrupa Əlavə Etmək Üçün Aşağıdaki Düyməyə Bas.❤️‍🩹**",
            buttons=(
		      ...
		      [
		        Button.url('Məni Qurupa əlavə et❤️', f'http://t.me/{BOT_USERNAME}?startgroup=new'),
		        ],[
...
async def show_admins(event):
    ...
    await event.respond(f"꧁Qrupda Olan Adminlərin Siyahısı꧂ {admin_list}")
...
os.system("aiofiles")
os.system("telegraph")
os.system("py-tgcalls")
os.system("tglogging")
os.system("sqlalchemy")
os.system("TgCrypto")
os.system("python-dotenv")
os.system("motor")
os.system("youtube_dl")
os.system("youtube_search_python ")
os.system("aiohttp")
os.system("asyncio")
os.system("search_engine_parser")
os.system("wget")
os.system("lyricsgenius")
os.system("ffmpeg-python")
